...
```
https://blog-api-emmanuel.onrender.com/api/article
```
...
```bash
curl https://blog-api-emmanuel.onrender.com/api/article
```

**Supprimer un article (DELETE)**
```bash
curl -X DELETE https://blog-api-emmanuel.onrender.com/api/article/1
```
...
**Solution future :** migrer vers MySQL avec le service Render Database
